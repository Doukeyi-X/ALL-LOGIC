...
static void _loadApp(AppOptions &o, QSettings &st)
{
    ...
    getFiled("mcpEnabled", st, o.mcpEnabled, true);
    getFiled("mcpPort", st, o.mcpPort, 10110);
    if (o.mcpPort < 1024 || o.mcpPort > 65535)
        o.mcpPort = 10110;
...
static void _saveApp(AppOptions &o, QSettings &st)
{
    ...
    setFiled("mcpEnabled", st, o.mcpEnabled);
    setFiled("mcpPort", st, o.mcpPort);
