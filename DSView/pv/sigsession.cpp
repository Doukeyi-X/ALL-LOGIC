...
namespace pv
{
    ...
    void SigSession::on_device_lib_event(int event)
    {
        ...
        case DS_EV_DEVICE_STOPPED:
            ...
            // Confirm that SR_DF_END was received. On some platforms (e.g. Windows
            // freewheel stop path) the end packet can race with this event — log
            // and force-mark complete instead of aborting the process.
            if (   !_capture_data->get_logic()->last_ended() 
